...
const OPTIONS = [
  {
    title: "100%",
    description: "Proyectos Personalizados",
  },
  {
    title: "200+",
  ...
  {
    title: "5/5",
    description: "Calificaciones de Satisfacción",
  },
];
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-6xl mx-auto items-center">
        ...
        <div className="col-span-1 mx-auto max-w-lg px-4 lg:px-0">
          ...
          <Typography
            ...
            Siempre estamos incorporando nuevas técnicas y tecnologías para ofrecerte los mejores resultados en corte y grabado láser.
          </Typography>
