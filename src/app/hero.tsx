      ...
      <header className="grid !min-h-[49rem] bg-gray-900 px-8">
        <div className="container mx-auto mt-32 grid h-full w-full grid-cols-1 place-items-center lg:mt-14 lg:grid-cols-2">
          <div className="col-span-1">
            ...
            <Typography
              variant="lead"
              className="mb-7 !text-white md:pr-16 md:pb-16 xl:pr-28"  placeholder={undefined} onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined}
              >
          ...
          <Image
            ...
            alt="team work"
            className="col-span-1 my-20 h-full max-h-[40rem] object-contain -translate-y-32 md:max-h-[46rem] lg:my-0 lg:ml-auto lg:max-h-[40rem] lg:translate-y-0"
          />
        </div>
      </header>
